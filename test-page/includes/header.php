...
$brandHref = $isHomePage ? '#home' : './index.php#home';

if (!isset($productSubmenu)) {
    $productSubmenu = [
        ['label' => 'Colour Masterbatches', 'href' => './colour-masterbatch.php'],
        ['label' => 'White Masterbatches', 'href' => './white-masterbatch.php'],
        ['label' => 'Additive Masterbatches', 'href' => './additive-masterbatches.php'],
        ['label' => 'Filler Masterbatches', 'href' => './filler-masterbatches.php'],
    ];
}
...
<head>
    ...
    <link rel="icon" type="image/png" href="./assets/images/fev.png" />
    ...
    <header id="home" class="site-header">
        <div class="container-fluid header-inner">
            <a class="brand" href="<?= htmlspecialchars($brandHref) ?>" aria-label="<?= htmlspecialchars($site['brand']) ?>">
                <img class="brand-logo" src="./assets/images/logo.png" alt="<?= htmlspecialchars($site['brand']) ?>" />
            </a>
                            ...
                            <div class="nav-dropdown-drop" id="products-submenu" role="region" aria-label="Product categories">
                                <ul class="nav-dropdown-panel" role="list">
                                    <?php foreach ($productSubmenu as $sub): ?>
                                        <li>
                                            <a class="nav-dropdown-link" href="<?= htmlspecialchars($sub['href']) ?>"><?= htmlspecialchars($sub['label']) ?></a>
                                        </li>
                                    <?php endforeach; ?>
                                </ul>
                            </div>
