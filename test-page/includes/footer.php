            ...
            <div class="footer-cols">
                <div class="footer-col">
                    ...
                    <div class="footer-item">
                        ...
                        <a class="footer-inline-link" target="_blank" rel="noopener noreferrer" href="https://www.google.com/maps/search/?api=1&query=1-13-056%2C%20Gopal%20Nagar%2C%20Yanam%20533%20464%2C%20U.T%20of%20Puducherry%2C%20India">
                    ...
                    <div class="footer-item">
                        ...
                        <span>
                            Phone:
                            <a class="footer-inline-link" href="tel:+918842321425">884-2321425</a>,
                            <a class="footer-inline-link" href="tel:+918842321462">2321462</a>
                        </span>
                    </div>
                    ...
                    <div class="footer-item">
                        ...
                        <span>
                            Email:
                            <a class="footer-inline-link" href="mailto:info@vasavipigments.com">info@vasavipigments.com</a>,
                            <a class="footer-inline-link" href="mailto:sales@vasavipigments.com">sales@vasavipigments.com</a>
                        </span>
                    </div>
                </div>
                ...
                <div class="footer-col footer-col-links">
                    ...
                    <nav class="footer-links" aria-label="Footer links">
                        <?php foreach ($nav as $item): ?>
                            <a class="footer-link" href="<?= htmlspecialchars($item['href']) ?>"><?= htmlspecialchars($item['label']) ?></a>
                        <?php endforeach; ?>
